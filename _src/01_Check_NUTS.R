...
# load NUTS II regions of Germany
ger_shp <- terra::vect("D:/EIE_Macroecology/_students/Romy/_Shapefiles/NUTS_RG_20M_2024_3035.shp/NUTS_RG_20M_2024_3035.shp")
terra::plot(ger_shp[LEVL_CODE == 2])
...
#- - - - - - - - - - - - - - - - - - - - - -
## Mask for each NUTS II region in Germany ####
