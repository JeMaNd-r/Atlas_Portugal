...
# plotAllVI
# 
# png(paste0(data_wd, "/_figures/VariableImportance_maxent_species_", Taxon_name, ".png"), height=800, width=600); plotAllVI; dev.off()
...
# 
# ## plot maps
# temp_files <- list.files(paste0(data_wd, "/_results/", Taxon_name, "/_TopPredictor"))
...
#   temp_pred <- get(load(file=paste0(data_wd, "/_results/", Taxon_name, "/_TopPredictor/", temp_files[m])))[["prediction"]]
#   #print(m)
...
# 
# #pdf(file=paste0(data_wd, "/_figures/DistributionMaps_", Taxon_name, "_", spID, ".pdf"))
# png(file=paste0(data_wd, "/_figures/DistributionMaps_", Taxon_name, "_MaxEnt.png"),width=3000, height=3000)
...
# ## View species stack
# 
# load(file=paste0(data_wd, "/_results/_TopPredictor/SDM_stack_MaxEnt_binary0.8_", Taxon_name, ".RData")) #species_stack
# 
# species_stack$Richness[species_stack$Richness == 0] <- NA
# 
# # species richness
# png(file=paste0(data_wd, "/_figures/SpeciesRichness_MaxEnt0.8_", Taxon_name, ".png"),width=1000, height=1000)
...
# #   subclim <- "TP"
# #   
# #   load(file=paste0(data_wd, "/_results/_Maps/SDM_stack_bestPrediction_binary_2041-2070_", no_future, "_", subclim, ".RData")) #species_stack
# #   
# #   # species richness
# #   png(file=paste0(data_wd, "/_figures/SpeciesRichness_", "2041-2070_", no_future, "_", subclim, "_", Taxon_name, ".png"),width=1000, height=1000)
# #   print(ggplot()+
# #           geom_map(data = world.inp, map = world.inp, aes(map_id = region), fill = "grey80") +
# #           xlim(-10, 30) +
# #           ylim(35, 70) +
...
# #   
# #   require(gridExtra)
# #   #pdf(file=paste0(data_wd, "/_figures/DistributionMap_bestBinary_2041-2070_", no_future, "_", subclim, "_", Taxon_name, ".pdf"))
# #   png(file=paste0(data_wd, "/_figures/DistributionMap_bestBinary_2041-2070_", no_future, "_", subclim, "_", Taxon_name, ".png"),width=3000, height=3000)
# #   do.call(grid.arrange, plots)
# #   dev.off()
# #   
# #   #while (!is.null(dev.list()))  dev.off()
...
# #- - - - - - - - - - - - - - - - - - - - - -
# 
# range_sum <- read.csv(file=paste0(data_wd, "/_results/Range_shift_", Taxon_name, ".csv"))
# 
# # plot species range decline
# png(file=paste0(data_wd, "/_figures/Range_shift_", "2041-2070_", Taxon_name, ".png"), height=600, width=800)
...
# load(file=paste0(data_wd, "/_results/_Maps/SDM_stack_future_species_", Taxon_name, ".RData")) #future_stack
# load(file=paste0(data_wd, "/_results/_Maps/SDM_stack_bestPrediction_binary_", Taxon_name, ".RData")) #species_stack
# 
# world.inp <- map_data("world")
# 
...
# 
# require(gridExtra)
# png(file=paste0(data_wd, "/_figures/DistributionMap_2041-2070_change_", Taxon_name, ".png"),width=3000, height=3000)
...
# # })})
# # require(gridExtra)
# # png(file=paste0(data_wd, "/_figures/DistributionMap_2041-2070_", Taxon_name, ".png"),width=3000, height=3000)
# # do.call(grid.arrange, plots)
# # dev.off()
# 
# #- - - - - - - - - - - - - - - - - - - - - -
...
# #- - - - - - - - - - - - - - - - - - - - - -
# 
# load(file=paste0(data_wd, "/_results/_Maps/SDM_stack_future_richness_change_", Taxon_name, ".RData")) #average_stack
# 
# # # plot future mean distribution
# # png(file=paste0(data_wd, "/_figures/SpeciesRichness_cert0.1_", "2041-2070_future_", Taxon_name, ".png"),width=1000, height=1000)
# # print(ggplot()+
# #         geom_map(data = world.inp, map = world.inp, aes(map_id = region), fill = "grey80") +
# #         xlim(-10, 30) +
# #         ylim(35, 70) +
...
# # png(file=paste0(data_wd, "/_figures/SpeciesRichness_cert0.1_", "2041-2070_change_", Taxon_name, ".png"),width=1000, height=1000)
# # print(ggplot()+
# #         geom_map(data = world.inp, map = world.inp, aes(map_id = region), fill = "grey80") +
# #         xlim(-10, 30) +
# #         ylim(35, 70) +
...
# png(file=paste0(data_wd, "/_figures/SpeciesRichness_cert0.1_", "2041-2070_change_ssp126_", Taxon_name, ".png"),width=1000, height=1000)
# print(ggplot()+
#         geom_map(data = world.inp, map = world.inp, aes(map_id = region), fill = "grey80") +
#         xlim(-10, 30) +
#         ylim(35, 70) +
...
# png(file=paste0(data_wd, "/_figures/SpeciesRichness_cert0.1_", "2041-2070_change_ssp370_", Taxon_name, ".png"),width=1000, height=1000)
# print(ggplot()+
#         geom_map(data = world.inp, map = world.inp, aes(map_id = region), fill = "grey80") +
#         xlim(-10, 30) +
#         ylim(35, 70) +
...
# png(file=paste0(data_wd, "/_figures/SpeciesRichness_cert0.1_", "2041-2070_change_ssp585_", Taxon_name, ".png"),width=1000, height=1000)
# print(ggplot()+
#         geom_map(data = world.inp, map = world.inp, aes(map_id = region), fill = "grey80") +
#         xlim(-10, 30) +
#         ylim(35, 70) +
...
# #- - - - - - - - - - - - - - - - - - - - -
# 
# load(file=paste0(data_wd, "/_results/_Maps/SDM_stack_future_richness_agreement_", Taxon_name, ".RData")) #average_stack
# 
# # plot number scenarios that predict gain/loss/no change
# png(file=paste0(data_wd, "/_figures/SpeciesRichness_cert0.1_", "2041-2070_change_noScenarios_", Taxon_name, ".png"), width=1100, height=1000)
# print({ggplot()+
#     geom_map(data = world.inp, map = world.inp, aes(map_id = region), fill = "grey80") +
#     xlim(-10, 30) +
#     ylim(35, 70) +
...
# #- - - - - - - - - - - - - - - - - - - - -
# 
# data_eval <- read.csv(paste0(data_wd, "/_results/Model_evaluation_", Taxon_name, ".csv"))
# 
